 ...
 * 기존에 있던것에서 삭제하면 크기가 줄어드는 배열을 동적할당이라고 한다.
 * 
 * 이 ArrayUtil 클래스는 동적할당을 위한 메소드들 뿐만 아니라
...
public class ArrayUtil {
        ...
        //2. 파라미터로 배열과 int 값을 넘겨받고 , 해당 int 값이 배열에 존재하면 true,
        ...
        //3. 파라미터로 배열과 int값을 넘겨받고 , 해당 int 값이 가장 먼저 등장하는 index를 알려주는
        //indexOf() 메소드
