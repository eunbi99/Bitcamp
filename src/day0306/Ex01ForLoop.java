 ...
 * for반복문은 비교적 횟수와 관계가 있는 반복문이다.
 * 
 * while반복문은 끝이 어딘지 모르는 무언가를 계속 읽어오거나 적을때 주로 사용이 되지만
 * for반복문은 끝이 명확하거나 순서가 있는 무언가를 다룰때 주로 사용이 된다.
 * 
 * for반복문은 주로 다음과 같은 형태를 가진다.
 * for(제어변수 선언; 반복 조건식 ; 제어변수 변화할당식){
 *      반복할 코드
 * }
 * 
 * 제어변수는 정수형 데이터타입의 변수를 사용해야하지만
 * 주로int i 라는 제어변수를 선언하고 초기화한다.
 */
public class Ex01ForLoop {
    ...
    public static void main(String[] args) {
         ...
         * 
         *2.제어변수의 초기화나 반복 조건시겡 다른 변수를 사용할 수도있다.
         *
         */
        System.out.println();
         ...
         * i의 현재값을 변화시킬 수 있는 할당 연산자면 뭐든 사용가능하다.
         */
        System.out.println("");
        ...
        /*4.초기단계에 가장 많이 하는 실수는
         * i자리에 1을 넣는 실수를 많이 한다.
         * 이러면 무한루프가 되거나 아예 for문이 시작 안할수도 있으니 주의해야한다.
         * 
         *5.i도 하나의 변수이다. 즉 유효범위가 for문 내부인 변수가 되니깐
         *중복선언을 조심해야한다.
         *
         *6.다른 제어문도 마찬가지이지만, for문도 ()뒤에 ; 을 붙이면
         *반복할 코드 블락이 아예 분리가 되어 의미가 바뀌게 되니 () 뒤에 ;을 붙이는 것을 주의!!
         */
    }
