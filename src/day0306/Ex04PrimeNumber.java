 ...
 *      예시) 5를 1로 나누어서 나눠떨어지먄 1은 5의 약수이다.
 *      =A를 B로 나누어서 나머지가 0이면 B는 A의 약수이다.
 * 3.어떤 숫자의 가장 큰 약수는?
 *      자기 자신이다.
 * 
 * 우리는 이 3가지 조건만 활용해서 1부터 100까지의 소수를 구하는 프로그램을 만들게 될것이다.
 */
public class Ex04PrimeNumber {
    ...
    public static void main(String[] args) {
        ...
        for(int i = iStart ; i<=iEnd; i++) {
            //i의 약수가 몇개인지 저장할 int변수 count를 선언과 초기화 해준다
            //ex)1과 2의 약수의 개수는 전혀 상관이 없기때문에 for문안에서 초기화해서 세줘야한다.
            int count=0;
