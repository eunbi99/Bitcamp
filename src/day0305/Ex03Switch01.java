 ...
 * Switch문
 * 
 * if문은 우리가 true/false가 나오는 조건식을 만들엇 
 * 해당 조건식이 true이면 실행 , false이면 실행하지 않음 이라는 구조엿지만
 ...
 *    
 *    break;
 *    break란 switch 혹은 반복문을 종료시키는 키워드이다.
 *    switch의 경우, 해달 변수가 만족하는 케이스에 적혀있는 코드부터 break가 나올때까지 모든 코드들이 다 실행이 된다.
 *    
 *    
 *        
 */
public class Ex03Switch01 {
    public static void main(String[] args) {
        ...
        /* switch의 변수에는 정수형, 문자형, 논리형이 들어갈 수 있다.*/
        byte b=1;
        switch(b) {
        case 1 :
