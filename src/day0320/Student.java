package day0320;
//학생 클래스 (학생 번호, userName, 비밀번호, 이름 , 소속 반, 점수 입력 여부, 국어 점수 , 영어점수 , 수학점수)
public class Student {
    ...
    public void print() {
        ...
        //점수 입력 여부의 현재값은  따로 출력을 해주는것이 아니라
        //점수 출력 자체를 결정 지어주는데 사용된다.
        System.out.println("====================================");
        if(scoreInputSwitch) {
            int sum = korean + english + math;
            double average = sum /(double)SUBJECT_SIZE;
            System.out.printf("국어점수 : %03d점 영어 점수 : %03d점 수학 점수 : %03d점 \n",korean ,english, math);
            System.out.printf("총점 : %03d점 평균 : %06.2f점 \n", sum, average);
            
        }else {
            System.out.println();
            System.out.println("아직 점수가 입력 되지 않은 학생입니다.");
            System.out.println();
        }
        System.out.println("===================================");
