...
public class LottoGame04Answer {
    ...
    public static void main(String[] args) {
        ...
        int idx =0;
        //idx가 lottoNumber.length 보다 작을 동안
        ...
        while (idx < lottoNumbers.length) {
            ...
            //사용자가 입력한 값이 (NUMBER_MIN 이상 && NUMBER_MAX 이하)가 아닐경우
            //반복이 되게 while문을 작성해준다.
            ...
            //사용자가 입력한 숫자가 중복이 아니면 true, 중복이면 false가 저장되는 numberChecker
            ...
            //false면 , 이미 중복된 숫자입니다. 라는 메시지만 출력해준다.
        ...
        //정렬해주는 for문
        //우리가 lottoNumbers의 i번째와 i+1번째를 비교해야하므로
        //이 for문의 반복 조건식은 i가 lottoNumbers의 크기보다 1 작을 동안으로 해야
        //4번째 5번째를 비교하고 for문이 종료되서 혹시라도 존재하지않은 6번째 인덱스에
        //접근이 안되게 한다.
        for(int i =0; i< lottoNumbers.length -1 ; i++) {
            if(lottoNumbers[i] > lottoNumbers[i+1]) {
                
                //lottoNumbers의 i번째에 할당된 값이 i+1번째보다 크다는건
                //큰 숫자가 앞에 나와있다는 의미이므로, 2개의 순서를 바꿔주어
                //더 작은 숫자가 앞으로 자리를 바꾸도록 만들어준다.
                ...
                //다시 배열의 제일 앞부터 정렬되어 있는지 검사하고 정렬할 수가 있게 된다.
                i=-1;
            }
        }
