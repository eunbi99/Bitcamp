 ...
 * 즉 2차원 배열이란, 어떤 데이터타입의 배열을 모아서 하나의 배열로 다루는것을 2차원 배열이라고 한다!
 * 
 * 2차원 배열의 선언과 초기화
 * 데이터타입[][] 배열이름 = new 데이터타입[크기1][크기2];
 * 크기1: 2차원배열의 크기
 * 크기2: 2차원배열안의 개별 배열의 크기. 단, 크기2는 생략 가능하다.
 * 
 */
public class Ex012DArray {
    public static void main(String[] args) {
        ...
        //위의 코드는 구어로 풀어서 말하면
        //"크기 3인 int 배열이 2개 모여있는 2차원 배열 double Array"가 된다.
        
        //doubleArray의 내용을 출력해보자
        System.out.println("doubleArray[0] : " + doubleArray[0]);
        System.out.println("doubleArray[1] : " + doubleArray[1]);
        
        //그러면, doubleArray의 인덱스 0번에 있는 배열의 인덱스 2번값을 출력해보자
