...
public class Ex02Calendar {
    public static void main(String[] args) {
        ...
        //Calendar 객체를 직접 찍어보면 우리가 알기 쉽게 볼 수 있는것이 아니라
        //내부의 필드 이름과 해당 필드의 값이 출력된다.
        //우리가 그것을 보고 실제 우리가 필요한 정보를 한눈에 알아보기는 매우 힘들다.
        //따라서 우리는 저기서  time필드값을 이용하여
        //예쁘게 출력해주어야한다.
        ...
        //그 안에 우리가 직접
        //어떤 형식으로 날짜를 포맷팅 해줄 지를 결정해 줄 수 있다.
        ...
        //Calendar객체에 시간을 넣는 방법
        //1. 1970년 01월 01일 0시 0분부터 원하는 시간까지를 1/1000초 단위로 구해서 직접 값을 넣는다. 
        //2. 원하는 연/월/일 시분초에 직접 setter를 통해서 값을 넣어준다.
        ...
        //바로 parse가 안되는 값을 바꿀려고 할 때가 그 잠재적 위험요소가 된다.
        //예시 : 만약 우리가 형식을 yyyy.MM.dd라고 정해놨는데
        //      사용자가 "으하하하"를 바꿔달라고 요청한다면?
        //그렇기 때문에 parse의 경우, 반드시 우리가 try/catch라는 것을 사용해서
        //parse를 시도해보고, 만약 해당 parse가 불가능해서 에러가 발생할 시에는
        //이러한 코드를 대신 실행하라고 자바에게 직접 적어주어야한다.
        try {
