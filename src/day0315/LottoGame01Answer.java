...
public class LottoGame01Answer {
        ...
        public static void main(String[] args) {
           ...
           int gameNumbers = ScannerUtil.nextInt(scanner, "몇게임 하실건가요?");
           ...
           for(int i=0; i< userNumbers.length; i++) {
               System.out.printf("사용자 숫자 : [%d,%d,%d,%d,%d,%d] 맞은 숫자 갯수 : %d개 등수 %d\n",
                       userNumbers[i][0],userNumbers[i][1],userNumbers[i][2],userNumbers[i][3],userNumbers[i][4],userNumbers[i][5],
        ...
        //4.2개의 배열을 비교하여 같은 숫자가 몇개있는지 비교하는 메소드
