...
public class GradeBook01 {
    ...
    private static void printAll() {
        ...
        //만약 list에 size가 0이면 "아직 입력된 정보가 존재하지않습니다."가 출력이 되고
        //일단 개별 보기후에 다시 여기에 오더라도 다시 목록을 볼 수 있도록
        //무한 루프를 만들어준다
            ...
            while(true) {
                ...
                //사용자가 0을 입력하면 -1이 되서 userChoice에 저장 되므로
                //userChoice가 -1이면 break를 통해 목록 보는것을 종료시킨다.
                //그외에는 해당 userChoice를 파라미터로 하는 개별 보기 메소드를 실행시켜준다.
                if(userChoice == -1) {
                    System.out.println();
    ...
    private static void delete(int index) {
        ...
        if(yesNo.equalsIgnoreCase("Y")) {
            ...
            //우리가 아무것도 하지 않아도 
            //delete(index)의 마지막줄 -> printOne(index)의 마지막 줄
            //로 이동하기 때문에
